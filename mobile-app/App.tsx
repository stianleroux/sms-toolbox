...
export default function App() {
	const [apiBaseUrl, setApiBaseUrl] = useState("https://sms-toolbox.cyborgc.workers.dev");
	const [apiKey, setApiKey] = useState("sms-toolbox-2026-secret");
	...
	return (
		<SafeAreaView style={styles.safe}>
			...
			<ScrollView contentContainerStyle={styles.container}>
				...
				<TextInput value={apiBaseUrl} onChangeText={setApiBaseUrl} autoCapitalize="none" autoCorrect={false} style={styles.input} placeholder="https://your-worker.workers.dev" />

				<Text style={styles.label}>API Key (optional)</Text>
				<TextInput value={apiKey} onChangeText={setApiKey} autoCapitalize="none" autoCorrect={false} style={styles.input} placeholder="x-api-key" />

				<Text style={styles.label}>Device ID</Text>
				<TextInput value={deviceId} onChangeText={setDeviceId} autoCapitalize="none" autoCorrect={false} style={styles.input} placeholder="android-phone-1" />
